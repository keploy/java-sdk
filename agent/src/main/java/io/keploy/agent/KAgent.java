...
//
//                })
//                // for DynamoDb autoGenerated attributes.
//                .type(named("com.amazonaws.services.dynamodbv2.datamodeling.DynamoDBMapper$SaveObjectHandler"))
//                .transform((builder, typeDescription, classLoader, module, protectionDomain) -> {
//                    logger.debug("inside DynamoDb autoGenerated attributes Transformer");
//                    return builder.method(named("onAutoGenerate")).intercept(MethodDelegation.to(TypePool.Default.ofSystemLoader().describe("io.keploy.dynamoDb.DynamoDbAutoGenerateInterceptor").resolve()));
//                })
