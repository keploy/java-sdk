...
public class KPreparedStatement implements PreparedStatement {
 ...
 public KPreparedStatement(String st, int aGeneratedKeys) {
  Query = st;
  autoGeneratedKeys = aGeneratedKeys;
 }
...
//  KResultSet.SetCommit(rs);
//  KConnection.FirstTime --;
//  FirstTime = false;
//  KResultSet.SetCommit(rs);
//  try {
...
//
//    ProcessSQL.ProcessDep(meta, null,rs);
//
//  } catch (InvalidProtocolBufferException e) {
//   throw new RuntimeException(e);
//  }
