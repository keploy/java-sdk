...
- **Configure Environment Variables**
  ...
  - `OKHTTP`     for okhttp service to be mocked or not (default OKHTTP = true)
  - `APACHE`     for apache service to be mocked or not (default APACHE = true)
  - `GOOGLE_MAPS`  for google_maps service to be mocked or not (default GOOGLE_MAPS = true)
  - `SQL`   	for sql service to be mocked or not (default SQL = true)
  - `REDIS`          for redis service to be mocked or not (default REDIS = true)
- **Generate testcases**
